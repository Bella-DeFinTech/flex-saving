...
contract bVault is ERC20, ERC20Detailed, WhiteListChecker, ReentrancyGuard {
    ...
    // use 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2 as WETH
    ...
    function withdrawETH(uint _shares) external notPaused nonReentrant {
        _withdrawETH(msg.sender, _shares);
    }
