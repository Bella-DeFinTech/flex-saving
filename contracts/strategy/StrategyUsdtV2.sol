...
contract StrategyUsdtV2 is CrvLocker {
    ...
    uint256 constant public TO_BCRV_DECIMALS = 1e12; // 1e18 3bcrv / 1e6 usdt
    ...
    function deposit() public {
        ...
        /// usdt -> bCrv Pool
        uint256[4] memory amounts = wrapCoinAmount(IERC20(want).balanceOf(address(this)), tokenIndexUsdt);
    ...
    function _withdrawAll() internal {
        ...
        ICrvPoolZap(busdPoolZap).remove_liquidity_one_coin(amount, tokenIndexUsdt, 1);
    }
    ...
    function underlyingBalanceInPool() public view returns (uint256) {
        ...
        uint balanceUnderlying = ICrvPoolZap(busdPoolZap).calc_withdraw_one_coin(balance, tokenIndexUsdt);
